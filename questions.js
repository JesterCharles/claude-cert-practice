// CCA-F practice questions — 210 total, 42 per domain. Generated from the official Exam Guide.
// Each: { id, domain, scenario, taskStatement, difficulty, stem, options:{A,B,C,D}, correct, explanations:{A,B,C,D} }
...
window.QUESTIONS = [
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "The agentic loop terminates correctly when you inspect `stop_reason`: `\"tool_use\"` means Claude wants another tool executed (loop again), `\"end_turn\"` means the model is finished. This is a deterministic control signal and the canonical pattern.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Tool results must be appended to conversation history (as `tool_result` blocks tied to the prior `tool_use` IDs) so the next iteration's reasoning is grounded in them. A side-channel scratchpad breaks the loop's continuity and the model effectively ignores those results.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "A common anti-pattern is treating the presence of assistant text as a completion signal. When Claude emits both reasoning text and `tool_use` blocks, exiting on the text check skips executing the tools and leaves the agent \"frozen\" with no further iterations.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Returning the actual error as a `tool_result` (flagged as an error) lets the model reason about *why* the call failed and pick a recovery — clarifying with the user, trying a different parameter, or escalating. This preserves model-driven decision-making.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "`stop_reason` is the canonical termination signal; iteration limits exist as a runaway safeguard, not as the deciding factor. Raising the cap just postpones the same problem.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "`end_turn` signals that the model has nothing further to do this turn — no tool calls requested — so the loop's exit condition is met.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Hub-and-spoke with a coordinator owning routing is the canonical multi-agent pattern — it centralizes observability, error handling, and information flow control.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Subagents do not automatically inherit the parent's context or memory. The coordinator must explicitly include relevant findings, constraints, and references in the subagent's prompt.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Overly narrow task decomposition by the coordinator leads to incomplete coverage of broad research topics. The fix is broader initial scoping plus an iterative refinement loop where the coordinator inspects the synthesis for gaps and re-delegates with targeted queries.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "A core coordinator responsibility is dynamic subagent selection based on query complexity — not always routing through the full pipeline. This minimizes wasted work and latency for simple cases.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Partitioning research scope across subagents by subtopic or source type is the recommended way to minimize duplication at the source.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Hub-and-spoke routes all inter-subagent calls through the coordinator so observability, error handling, and information flow stay consistent and debuggable.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "The `Task` tool is the spawn mechanism for subagents; if it isn't in the coordinator's `allowedTools`, the coordinator can't invoke any subagent.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Use a structured data format when passing context between agents so source metadata (URLs, document names, page numbers) stays attached to the content it came from. Flattening to prose destroys attribution.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Parallel subagent spawning is achieved by emitting multiple Task tool calls in a single coordinator response — the SDK can dispatch them concurrently rather than serially across turns.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Coordinator prompts should specify goals and quality criteria rather than step-by-step procedures. This lets the subagent adapt its plan when the environment differs from what the coordinator expected.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "`fork_session` is built precisely for forking from a shared baseline to explore divergent approaches in isolation.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "AgentDefinition typically specifies description (what it's for), system prompt (how it behaves), and tool restrictions (what it can do).",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Prompt instructions have a non-zero violation rate. For deterministic compliance (especially financial), programmatic enforcement (hooks or prerequisite gates) is required.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Multi-concern customer requests should be decomposed into distinct items, investigated in parallel using shared context (e.g., the verified customer), and synthesized into one coherent response.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Structured handoff summaries (customer ID, root cause, amount, recommended action) give the human agent — who lacks access to the transcript — the exact information needed to resume work efficiently.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Programmatic prerequisite/interception gates produce deterministic compliance — they catch violations before the tool fires.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "SOX-style controls require deterministic guarantees. Programmatic prerequisites give that; prompt instructions don't.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "The tradeoff is flexibility vs. determinism. Prompts are flexible and easy to iterate but provide no guarantee — acceptable for low-stakes ordering, insufficient for financial controls.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "PostToolUse hooks intercept tool results and let you normalize heterogeneous formats deterministically before the model ever sees them — exactly the use case for this hook pattern.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Tool call interception hooks evaluate outgoing tool calls before they execute, allowing deterministic policy enforcement and redirection to alternative workflows.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "A PostToolUse hook is the right mechanism for transparent, deterministic normalization across heterogeneous tool outputs. Once normalized, the model and downstream subagents work on a consistent schema.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Hooks give deterministic guarantees; prompts give probabilistic guidance. Choose based on how strict the compliance requirement is.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Hooks shape what the model sees; any \"decorative\" addition becomes part of the data the model reasons over. Normalization should be faithful, not creative.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "PostToolUse is exactly the hook pattern for intercepting and transforming tool results.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "PR reviews are predictable and multi-aspect — a classic case for prompt chaining: per-file passes for consistent local depth, plus a cross-file integration pass for system-level concerns.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Open-ended tasks need adaptive decomposition: explore structure, prioritize by impact, and let the plan evolve as you learn about dependencies and risk.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Open-ended investigation benefits from generating subtasks based on what's discovered at each step, exactly what dynamic adaptive decomposition delivers.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Prompt chaining suits predictable workflows with enumerable steps; PR review's local-then-integration pattern is the canonical example.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Per-file focused passes ensure consistent depth, and a separate integration pass catches cross-file issues — directly mitigating attention dilution.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Per-file passes plus a dedicated cross-file integration pass is the classic decomposition for code review: local depth + system-level checks.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "`--resume <session-name>` is the canonical way to continue a specific prior conversation by name.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "When resuming after code changes, the right move is to inform the agent about the specific changes so it can do targeted re-analysis rather than relying on stale tool results.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "When prior tool results are stale (especially after extensive code changes), it's more reliable to start fresh with a structured summary injected as context rather than resume a session whose memory has drifted out of sync with reality.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "`fork_session` is purpose-built for parallel exploration branches from a shared analysis baseline — exactly this comparison-of-strategies use case.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "The right axis is staleness of prior tool results. If the world hasn't moved much, resume; if it has, start fresh with a curated summary to avoid being misled by cached observations.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Forks inherit the parent's baseline. When that baseline is invalidated by an external change, the correct action is to inject a targeted summary of the change so the agent can re-analyze affected areas — rather than starting over or hoping the divergent reasoning catches it.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "The root cause is near-identical descriptions of overlapping tools. Renaming for purpose-specificity and writing differentiated descriptions (inputs, outputs, \"use this when…\") is the canonical fix for misrouting between similar tools.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Good tool descriptions include input format, expected outputs, prerequisites, edge cases, and boundaries versus similar tools — all of which this description supplies.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Splitting a generic tool into purpose-specific tools with defined I/O contracts is the prescribed pattern: it gives the model unambiguous selection signals and stabilizes output shape per tool.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Keyword-sensitive system-prompt wording can override well-written tool descriptions. Reviewing the prompt for words that overlap with tool names and adjusting either the wording or the tool's description is the targeted fix.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "When three tools have near-identical descriptions, the first design step is to determine whether they're functionally distinct. Either consolidate to one well-described tool or differentiate purposes — both fixes start from this audit.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Tool descriptions are the primary mechanism the model uses for selection. A minimal description like \"Searches code\" gives no advantage over the rich built-in `Grep` semantics, so Claude defaults to what it knows.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "When two tools serve different purposes but have overlapping descriptions, the right move is to rewrite descriptions that explicitly differentiate scope and include \"use this versus…\" boundary language.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Tool descriptions are the primary mechanism, supported by parameter schemas, names, and the surrounding prompt and conversation context.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Replacing a generic tool with a constrained, purpose-specific alternative (allowlisted documents, validated URLs) is the recommended pattern. The constraints become part of the interface contract rather than relying on the model to follow instructions.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Uniform \"Operation failed\" responses give the agent no basis for recovery. Structured metadata with category and retryability is the documented fix.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Business-rule failures should be marked with `errorCategory: \"business\"`, `isRetryable: false`, and a customer-friendly explanation that lets the agent communicate accurately and offer alternatives.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Local recovery for transient failures within the subagent (with structured propagation of unresolved failures, partial results, and attempts) is the documented multi-agent error pattern.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "\"No matches\" is a successful query, not a failure. The MCP error pattern distinguishes access failures (which need retry decisions) from valid empty results.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Expired credentials are a permission failure; retries by the agent won't resolve it. Marking `isRetryable: false` and surfacing operator-actionable language prevents wasted attempts.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "`isError` is the standard MCP pattern for surfacing failures to the agent so it can make recovery decisions.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Customer-friendly explanations on business-rule failures, plus `isRetryable: false`, let the agent communicate accurately and choose an appropriate next step.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Subagents should propagate partial results plus structured metadata about what failed and what was attempted, so the coordinator can make an informed decision.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Tool selection reliability degrades as the surface grows (e.g., 18 tools vs 4–5). The principle is to scope each agent's tool set to its role.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Agents with tools outside their specialization tend to misuse them. Scoping tool access to the subagent's role — with carefully chosen cross-role tools (e.g., a constrained `verify_fact`) — is the documented pattern.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "A scoped cross-role tool for a high-frequency narrow need is the prescribed pattern: it avoids handing over a powerful general tool while keeping complex cases routed through the coordinator.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Forced tool selection via `tool_choice` with a specific tool name is the supported way to guarantee that exact tool is called on a turn.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Forced tool selection guarantees the first step; auto on subsequent turns gives the model latitude to choose enrichment based on context. This is the canonical pattern.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "`tool_choice: \"any\"` ensures the model invokes some tool rather than producing free-text, which is exactly the behavior described.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Coordinators delegate; tool distribution should keep each agent's surface scoped to its role. Stripping the coordinator down to delegation tools prevents the \"help out\" anti-pattern.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "This is the principle stated directly in the task statement.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Forced tool selection on the first turn followed by auto on later turns is the canonical pattern for \"always start with X, then plan freely.\"",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Project-level `.mcp.json` is for shared team tooling; user-level `~/.claude.json` is for personal/experimental servers. This is the recommended scoping pattern.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Environment variable expansion (`${GITHUB_TOKEN}`) in `.mcp.json` is the documented pattern for keeping secrets out of source control while still sharing the configuration.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "When agents prefer built-ins over more capable MCP tools, the documented fix is to enhance the MCP tool's description so the model can recognize when to prefer it.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "MCP resources are the mechanism for exposing content catalogs to the agent up-front, which is the documented way to reduce exploratory tool calls.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Choosing existing community MCP servers for standard integrations (like Jira) saves implementation cost and ongoing maintenance; custom servers are for team-specific needs.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "All configured MCP servers' tools are discovered at connection time and remain available simultaneously.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Resources are for catalogs/content visibility; tools are for action. Exposing the catalog as resources reduces exploratory tool calls and gives the agent up-front visibility into what's available.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Environment variable expansion is the correct pattern; the fix is to make sure the CI environment provides the variable via its secrets mechanism.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "`Grep` searches file contents for patterns — exactly the operation needed to find callers of a function across a codebase.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "`Glob` is designed for file-path pattern matching — the canonical use case for finding files by name/extension.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "The documented fallback for non-unique `Edit` anchors is `Read` + `Write`: load the file, modify in memory, write the full new contents.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Incremental exploration — Grep/Glob for entry points, Read to follow imports, trace flows on demand — is the recommended pattern for understanding unfamiliar code.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Tracing function usage across wrappers requires first enumerating exported names, then searching for each name — exactly the documented technique.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "`Edit` is the right tool for targeted modifications when there's unique anchor text identifying the change location.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "This sequence — Grep to enumerate sites, Read to inspect local aliases, Edit or Read+Write per file based on anchor uniqueness — is the prescribed pattern for codebase-wide refactoring with built-in tools.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Grep finds content matches; Read confirms each site's context; Edit applies a targeted change (or Read+Write when anchors aren't unique). This is the documented chain for content-anchored refactors.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Project-level CLAUDE.md (committed to the repo) is the mechanism for sharing instructions with the whole team. User-level `~/.claude/CLAUDE.md` applies only to the local user.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Directory-level CLAUDE.md files load when working in that subdirectory, scoping context naturally. The root file then carries only repo-wide conventions.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "`.claude/rules/` with topic-specific files keeps content modular, easier to maintain, and avoids a monolithic file. CLAUDE.md can pull them in via `@import` when needed.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "`/memory` is purpose-built to surface which memory files are currently loaded, making it the right diagnostic tool for this exact problem.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "`@import` is the supported mechanism to compose CLAUDE.md from external files, keeping each package's config focused while reusing a single source of truth.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "User-level rules apply only to that user. To make a rule team-wide, it must live in a project-level configuration file committed to the repo.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "The most likely cause is the inherited import still references REST conventions. Each service's CLAUDE.md should import only the standards relevant to its domain.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Project-scoped commands live in `.claude/commands/` and are shared via version control, exactly the case for a team-wide release workflow.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "`context: fork` runs the skill in a sub-agent so verbose internal output stays out of the main conversation; only the summary is returned. This is the canonical use case.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Personal skill variants in `~/.claude/skills/` with a distinct name let you customize behavior locally without affecting teammates' workflows.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "`argument-hint` is designed precisely to prompt for required parameters at invocation when they are missing.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "`allowed-tools` in skill frontmatter restricts tool access during skill execution. This is the enforcement mechanism, not a request in prose.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "CLAUDE.md is for always-loaded universal standards; skills are for on-demand task-specific workflows. The right tool depends on whether the content should always apply or be invoked deliberately.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Exploratory or brainstorming skills are the canonical use case for `context: fork` — keep the noisy intermediate work out of the main conversation.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Path-scoped rules with glob patterns load only when editing matching files, which is ideal for cross-cutting conventions like test files spread throughout the codebase.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "YAML `paths` glob scoping in `.claude/rules/` loads the rule only for matching files, minimizing context usage elsewhere.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Glob-pattern rules in `.claude/rules/` are designed precisely for conventions that span multiple directories without duplication.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Path-scoped rules only load on matching files; if rules are appearing for non-matching paths, another always-loaded file (CLAUDE.md or non-scoped rule) is likely the source.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Use directory-level CLAUDE.md for directory-scoped conventions and path-scoped rules for conventions that span across directories — different problems, different mechanisms.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Without `paths` scoping, a rule file is treated as always-on. Adding a `paths` glob limits activation to matching files.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Glob patterns can exclude test files from the component rule, so each rule activates only for its intended file type and the contradictions disappear.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Direct execution is appropriate for simple, well-scoped changes with a clear diagnosis (a single-file bug fix is the canonical example).",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Plan mode is designed for tasks with architectural choices, multi-file scope, and multiple valid approaches — exactly this migration's profile.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "The Explore subagent isolates verbose discovery output and returns concise summaries, preserving main-conversation context for later phases.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Plan-then-execute is the recommended pattern: plan mode for architectural investigation, direct execution to carry out the planned approach.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Direct execution is the right choice when scope is small, the diagnosis is precise, and there's a clear single change to make.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Plan mode is designed precisely for tasks with multiple valid approaches and architectural implications — laying out trade-offs before committing prevents costly rework.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "The Explore subagent is meant to isolate verbose discovery and return summaries, preserving main-conversation context — useful during implementation as well as initial discovery.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Concrete input/output examples are the most effective way to disambiguate transformations when prose is interpreted inconsistently.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "The interview pattern surfaces considerations the developer may not have anticipated, which is especially valuable in unfamiliar domains like cache invalidation.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Test-driven iteration involves writing tests first and using failures as concrete feedback to guide Claude's progressive improvement.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "When fixes are independent, sequential iteration is cleaner. Bundling everything into one message is reserved for interacting problems.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "When issues interact, a single detailed message lets Claude reason about the interactions and produce a coherent fix.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Concrete input/output examples are the single most effective way to communicate exact transformations when prose is interpreted inconsistently.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "The interview pattern surfaces design considerations and choices ahead of implementation, especially valuable for opinionated cross-cutting concerns like retry policies.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "The `-p` / `--print` flag is the documented way to run Claude Code non-interactively in pipelines, preventing waits on stdin.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "`--output-format json` plus `--json-schema` produces structured, schema-validated output suitable for automated parsing.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Feeding prior findings into context and asking Claude to suppress duplicates is the recommended pattern for re-reviews after new commits.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Without visibility into the existing test suite, Claude can't know what's already covered. Including the existing tests in context lets it complement rather than duplicate.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "CLAUDE.md is the documented mechanism for providing project context (testing standards, fixture conventions, review criteria) to CI-invoked Claude Code. Running from the right directory ensures it loads.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "A Claude session that generated code is less effective at reviewing it because the prior reasoning anchors the review. An independent review instance avoids that bias.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "`--json-schema` enforces structural validity. It's the documented way to guarantee machine-parseable output beyond just \"format: json.\"",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Explicit categorical criteria — naming which issues to report and which to skip — give the model concrete decision boundaries, while general \"be conservative\" instructions have been shown not to reliably suppress unwanted categories.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "This replaces a vague directive with a precise behavioral criterion plus an example, exactly matching the \"explicit criteria over vague instructions\" principle from TS 4.1.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "TS 4.1 emphasizes defining explicit severity criteria with concrete examples for each level — this gives the model a deterministic mapping rather than asking it to guess what \"importance\" means.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "TS 4.1 calls out temporarily disabling high-FPR categories to restore developer trust in the accurate categories while you iterate; trust is contagious across the bot's output as a whole.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Explicit, mutually exclusive categorical criteria with definitions are exactly the TS 4.1 prescription — they replace a vague \"inconsistency\" directive with operationally distinct conditions.",
  ...
  },
  {
    ...
    "correct": "C",
    "explanations": {
      "C": "C names exact categories to include and exclude, the canonical TS 4.1 \"explicit categorical criteria\" pattern.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Disabling high-FPR categories temporarily, while iterating on better criteria, is the TS 4.1 recommendation to protect trust in the rest of the system.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "TS 4.2 explicitly calls out few-shot examples as the most effective technique when instructions alone produce inconsistent extraction, especially for varied document structures and informal phrasings.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "TS 4.2 highlights that few-shot examples demonstrating the desired output format (location, issue, severity, suggested fix) are the most effective way to achieve consistency when descriptive instructions alone produce ~70% compliance.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "TS 4.2 calls out using a few targeted examples that demonstrate correct handling of varied document structures (inline citations vs. bibliographies); covering each structural variant with one clear example enables generalization across the patterns.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Few-shot examples that show reasoning for why one action was chosen over plausible alternatives — exactly the TS 4.2 skill — enable the model to generalize judgment to novel branches rather than matching specific surface features.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "This is the core TS 4.2 finding: few-shot examples are the most effective lever for consistent, well-formatted output for ambiguous or varied inputs.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "TS 4.2 calls out using few-shot examples that distinguish acceptable code patterns from genuine issues to reduce false positives while enabling generalization beyond a single pattern.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "TS 4.2 calls out adding few-shot examples for documents with varied formats and missing required fields to prevent fabrication, demonstrating the desired \"missing\" or null behavior.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "TS 4.3: tool use with a JSON schema is the most reliable approach for guaranteed schema-compliant structured output and eliminates JSON syntax errors entirely.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "TS 4.3 explicitly recommends `tool_choice: \"any\"` when multiple extraction schemas exist and the document type is unknown — it guarantees structured output while letting the model pick the right tool.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "TS 4.3 explicitly covers forcing a specific tool via `tool_choice: {\"type\": \"tool\", \"name\": \"extract_metadata\"}` to ensure a particular extraction runs before enrichment steps.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "TS 4.3 covers designing schema fields as optional/nullable when source documents may not contain the information, preventing the model from fabricating values to satisfy required fields.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "TS 4.3 covers the \"other\" + detail-string pattern as the canonical extensible categorization design — it preserves precision for known categories and captures the unknown without forcing misclassification.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "TS 4.3 is explicit: tool-use schemas eliminate JSON syntax errors but do not prevent semantic errors (values in wrong fields, totals that don't sum).",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "TS 4.3 calls out including format normalization rules in the prompt alongside strict output schemas to handle inconsistent source formatting; schemas alone don't enforce normalization semantics.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "TS 4.4 describes the retry-with-error-feedback pattern: include the original document, the failed extraction, and specific validation errors so the model can self-correct.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "TS 4.4 explicitly distinguishes when retries succeed (format/structural errors) from when they don't (information is simply absent from the source). When data isn't present, retries cannot recover it without changing the input.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "TS 4.4 calls out adding `detected_pattern` fields to enable systematic analysis of dismissal patterns — once you can group dismissals by pattern, you can target prompt fixes precisely.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "TS 4.4's self-correction validation flow exactly recommends extracting `calculated_total` alongside `stated_total` so that a discrepancy can be flagged and surfaced for correction.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "TS 4.4 calls out adding \"conflict_detected\" booleans (and supporting fields) for inconsistent source data, which routes ambiguous cases to human review instead of silently choosing.",
  ...
  },
  {
    ...
    "correct": "C",
    "explanations": {
      "C": "TS 4.4 distinguishes semantic validation errors (values don't sum, wrong field placement) from schema syntax errors — tool use eliminates the syntax errors but not the semantic ones, which retry-with-error-feedback can address.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Structured detected_pattern logging gives you the data needed to do systematic prompt fixes, the exact TS 4.4 skill.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "TS 4.5 explicitly states batch is inappropriate for blocking workflows (pre-merge checks) because the up-to-24-hour window and lack of latency SLA conflict with the workflow's need to gate merges.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "TS 4.5 prescribes matching API approach to latency: synchronous for blocking pre-merge checks, batch for overnight/weekly analyses where 24-hour processing is acceptable.",
  ...
  },
  {
    ...
    "correct": "C",
    "explanations": {
      "C": "TS 4.5 covers calculating batch submission frequency from SLA constraints: a 4-hour cadence keeps total worst-case latency (wait + 24h processing + buffer) within the 30-hour SLA.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "TS 4.5 covers using `custom_id` to identify failed documents and resubmitting only those with appropriate modifications (e.g., chunking when the failure was a context overflow).",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "TS 4.5 calls out prompt refinement on a sample before batch-processing large volumes to maximize first-pass success rates and avoid expensive iterative resubmission across 200K items.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "TS 4.5 highlights that the batch API doesn't support multi-turn tool calling within a single request (it can't execute tools mid-request and return results); for tool loops you need an alternative approach.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "TS 4.5 covers `custom_id` as the mechanism for correlating batch request/response pairs since results arrive asynchronously.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "TS 4.6 highlights this exact self-review limitation: a model retains reasoning context from generation in the same session and is less likely to question its own decisions.",
  ...
  },
  {
    ...
    "correct": "C",
    "explanations": {
      "C": "TS 4.6 specifies using a second independent instance (without prior reasoning context) for substantive review; this catches subtle issues that self-review misses.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "TS 4.6's multi-pass review prescription: per-file passes for local issues plus a separate cross-file integration pass — exactly addressing attention dilution and contradictory findings.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "TS 4.6 calls out verification passes where the model self-reports confidence alongside each finding to enable calibrated review routing — and audits to validate the calibration over time.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Independent review by another agent without the original reasoning context is more effective at catching subtle issues than self-review — TS 4.6's central insight.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "TS 4.6 directly states that independent review instances without prior reasoning context are more effective at catching subtle issues than self-review.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "TS 4.6 prescribes splitting large reviews into per-file local passes plus a separate integration-focused pass examining cross-file data flow — directly solving local depth and cross-file coverage without overloading any single pass.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Transactional facts (amounts, dates, order numbers) must be extracted into a persistent structured block that survives summarization, because progressive summarization predictably degrades exact numerical values into vague phrases.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Trimming verbose tool outputs to only the fields that matter prevents disproportionate token consumption and avoids burying earlier salient information.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "When a downstream agent has limited context, upstream agents should return compact structured data (key claims, citations, scores) so the synthesis agent receives high-signal input rather than verbose prose.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "The lost-in-the-middle effect causes models to under-attend to content in the middle of long inputs. Surfacing key findings at the start and labeling each section explicitly mitigates this positional bias.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Multi-issue sessions require structured persistence of issue data (IDs, amounts, statuses) in a separate context layer so the agent can disambiguate without relying on conversational recall.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Models are stateless across API calls — the application is responsible for sending the conversation history each turn to preserve continuity.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Structured metadata (dates, sources, methodology) accompanying each finding is what enables a downstream synthesis agent to interpret and combine results accurately.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Explicit customer demand for a human is one of the canonical escalation triggers; the agent should escalate immediately without prior investigation.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Frustration alone is not a valid escalation trigger; the right pattern is to acknowledge sentiment while offering resolution within capability, escalating only if the customer reiterates.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Policy ambiguity or silence on a specific request is a canonical escalation trigger — the agent should hand off to a human authorized to make the call, not improvise.",
  ...
  },
  {
    ...
    "correct": "C",
    "explanations": {
      "C": "Multiple matches require clarification by asking for additional identifiers, not heuristic selection — exactly the pattern described in the task statement.",
      "A": "Both are heuristics that produce confident-but-wrong selections, which is the failure mode being observed.",
      "B": "Both are heuristics that produce confident-but-wrong selections, which is the failure mode being observed.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Self-reported confidence is a poor proxy; reliable escalation criteria should be explicit (human request, policy ambiguity, lack of progress) with few-shot examples in the system prompt.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Explicit criteria plus few-shot examples covering boundary cases is the documented pattern for teaching escalation decisions.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Codifying valid escalation triggers with negative examples (not \"doubt,\" not \"slowness\") teaches the model the right boundaries.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Structured error context (type, attempted operation, partial results, alternatives) enables coordinator-level recovery decisions; generic strings hide essential information.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Distinguishing access failures from valid empty results lets the coordinator choose retry vs. proceed appropriately.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Subagents should handle transient failures locally and only escalate unresolvable ones with structured context (what was tried, partial results).",
  ...
  },
  {
    ...
    "correct": "C",
    "explanations": {
      "C": "Coverage annotations distinguishing supported findings from gap areas (with specifics) preserve provenance and let downstream consumers act on the gaps.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Coordinator recovery requires structured failure-type, attempt, partial-result, and alternative-approach fields.",
  ...
  },
  {
    ...
    "correct": "C",
    "explanations": {
      "C": "Whole-workflow termination on isolated failures is a documented anti-pattern; structured errors enable localized recovery decisions.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Silently suppressing errors by returning empty success is the canonical anti-pattern; it hides failures from the coordinator.",
      "B": "All are recommended practices for resilient subagent error handling.",
      "C": "All are recommended practices for resilient subagent error handling.",
      "D": "All are recommended practices for resilient subagent error handling."
    }
  },
  {
    "id": "d5-q22",
    ...
    "correct": "A",
    "explanations": {
      "A": "Scratchpad files persist key findings across context degradation and counteract the model's drift toward generic \"typical patterns\" language.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Subagent delegation isolates verbose discovery output so the coordinating agent's context remains focused on high-level synthesis.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "`/compact` is the documented mechanism for reducing context usage during extended sessions when context fills with verbose discovery output.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Summarizing phase-1 findings into structured notes and injecting them into phase-2 prompts both saves context and ensures continuity.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Structured agent state exports plus a coordinator-loaded manifest is the documented crash-recovery design.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Subagent-per-unit-of-work with structured exports plus coordinator synthesis is the canonical pattern for large codebase exploration.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Drift to generic \"typical patterns\" language instead of specific discovered references is the documented degradation signal.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Aggregate accuracy can mask poor per-segment performance; per-document-type and per-field analysis is the documented prerequisite for automating high-confidence extractions.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Stratified random sampling of the automated bucket is precisely what detects novel error patterns and accuracy regressions over time.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Per-field numeric confidences calibrated against labeled validation data are the documented pattern for setting reliable review thresholds.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Routing low-confidence or source-ambiguity cases to humans concentrates review where it adds the most value.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Field- and document-type-level validation is required before reducing review; otherwise an aggregate average can hide a weak field like \"payer EIN.\"",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Stratification ensures each segment is represented and that novel error patterns confined to one stratum are detected.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "Stratified sampling that explicitly covers low-volume strata catches issues that aggregate metrics miss.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Structured claim-source mappings preserved through synthesis are the documented mechanism for maintaining provenance.",
  ...
  },
  {
    ...
    "correct": "B",
    "explanations": {
      "B": "When credible sources disagree, the synthesis agent should annotate the conflict with attribution rather than arbitrarily select a value.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Publication and collection dates in structured outputs let downstream agents correctly interpret temporal differences vs. genuine contradictions.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Explicit sections separating established from contested findings, with preserved source context, is the recommended structure.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Subagents should surface conflicts with full annotation so the coordinator (which has broader context) can decide on reconciliation policy.",
      "B": "Arbitrary local heuristics that may not match the coordinator's policy.",
      "C": "Arbitrary local heuristics that may not match the coordinator's policy.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Matching the rendering format to content type (tables for financials, prose for news, structured lists for technical) preserves the natural shape of each finding.",
      "B": "Single-format approaches lose the affordances appropriate to each content type.",
      "C": "Single-format approaches lose the affordances appropriate to each content type.",
  ...
  },
  {
    ...
    "correct": "A",
    "explanations": {
      "A": "Structured claim-source mappings preserved through synthesis are the documented mechanism for auditable provenance.",
